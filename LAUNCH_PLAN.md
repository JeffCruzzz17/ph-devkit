# PH DevKit Launch Plan

## Goal

Launch PH DevKit on App Builders PH as a useful Developer Tools product for Filipino makers.

## Launch positioning

**PH DevKit helps Filipino developers ship local-ready apps faster.**
...
I am building **PH DevKit**, a free starter toolkit for Filipino developers building Philippine-ready web apps.

The MVP includes:

- React address selector
- Peso formatter
- PH mobile number validator
...
- Submit to App Builders PH
- Post founder comment
- Share with 5-10 developers for feedback
- Reply to every comment

### Day 2

- Ship one quick improvement from feedback
- Post changelog comment

### Day 3

- Add one missing example or doc page
- Ask for specific feedback on the playground

### Day 4

- Share before/after example of using PH DevKit
- Comment on other apps thoughtfully

### Day 5

- Ask real testers for honest review
- Improve screenshots if needed

### Day 6

- Add a requested utility or component idea to roadmap
- Publish roadmap update

### Day 7

- Share first-week learnings
- Ask which feature should be built next

## Target metrics

- Launch day: 10+ upvotes
- First week: 25+ upvotes
