...
- [x] Add core package scaffold
- [x] Add React package scaffold
...
- [ ] Submit app under Developer Tools
- [ ] Post founder comment
- [ ] Share tester/feedback request
- [ ] Reply to every comment
- [ ] Ship one improvement within 48 hours
- [ ] Ask real testers for reviews

## Phase 4 - Post-launch roadmap

- [ ] Full PSGC dataset import guide
- [ ] Searchable address selector
- [ ] React Hook Form example
- [ ] Laravel package starter
- [ ] NuGet package starter
- [ ] Auth/RBAC module
- [ ] Audit log module
